-- ===================================================================
-- CHORE WARS DATABASE SETUP (MySQL)
-- ===================================================================
-- Copy/paste friendly schema for the Group Invite system.
--
-- How to use:
-- 1) Select your database in phpMyAdmin (left sidebar)
-- 2) Open the SQL tab
-- 3) Paste this entire script and click Go
--
-- Requirements:
-- - This script expects a `users` table with an `id` column to exist.
--   If you don't have one yet, use the OPTIONAL stub below (uncomment it),
--   or run your own users schema first, then run this script.
--
-- Notes:
-- - Identifiers are backticked (`) for safety.
-- - Removed non-portable COMMENT clauses on indexes/constraints.
-- - Uses utf8mb4 + InnoDB.
-- ===================================================================

-- Recommended session settings (safe to keep)
SET NAMES utf8mb4;
SET time_zone = '+00:00';
...
-- ===================================================================
-- OPTIONAL: Minimal users table stub for testing (uncomment to create)
-- ===================================================================
